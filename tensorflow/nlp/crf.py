...
# Features
# Next, define some features. In this example we use word identity, word suffix, word shape and word POS tag;
...
trainer.train('experiments/pycrfsuite/conll2002-esp.crfsuite')
...
tagger.open('experiments/pycrfsuite/conll2002-esp.crfsuite')
